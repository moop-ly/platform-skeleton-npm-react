        ...
        <tbody>
          {items.map((item) => (
            <tr key={item["@id"]}>
              ...
              <td>{item["name"]}</td>
              <td>{item["postOfficeBoxNumber"]}</td>
              ...
              <td>
                <Link
                  to={`/postaladdressess/show/${encodeURIComponent(
                    item["@id"]
                  )}`}
                >
              ...
              <td>
                <Link
                  to={`/postaladdressess/edit/${encodeURIComponent(
                    item["@id"]
                  )}`}
                >
...
const List = () => {
  ...
  const id = (page && decodeURIComponent(page)) || "postal-addresses";
