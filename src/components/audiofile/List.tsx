        ...
        <tbody>
          {items.map((item) => (
            <tr key={item["@id"]}>
              ...
              <td>
                <Link
                  to={`/audiofiles/show/${encodeURIComponent(item["@id"])}`}
                >
              ...
              <td>
                <Link
                  to={`/audiofiles/edit/${encodeURIComponent(item["@id"])}`}
                >
...
const List = () => {
  ...
  const id = (page && decodeURIComponent(page)) || "audio-files";
