...
const ShowView = ({
  ...
  if (deleted) {
    return <Navigate to="/audiofiles/" replace />;
  }
  ...
  return (
    <div>
      <h1>Show AudioFile {item && item["@id"]}</h1>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <Links
                  items={{
                    href: `/audio/show/${encodeURIComponent(item["media"])}`,
                    name: item["media"],
                  }}
                />
              </td>
            ...
            <tr>
              ...
              <td>{item["duration"]}retrieved</td>
            </tr>
            <tr>
              <th scope="row">progress</th>
              <td>{item["progress"]}retrieved</td>
            </tr>
            <tr>
      ...
      <Link to="/audiofiles/" className="btn btn-primary">
        Back to list
      </Link>
      {item && (
        <Link to={`/audiofiles/edit/${encodeURIComponent(item["@id"])}`}>
