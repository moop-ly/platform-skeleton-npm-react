        ...
        <tbody>
          {items.map((item) => (
            <tr key={item["@id"]}>
              ...
              <td>
                <Link
                  to={`/documenttemplates/show/${encodeURIComponent(
                    item["@id"]
                  )}`}
                >
              ...
              <td>
                <Link
                  to={`/documenttemplates/edit/${encodeURIComponent(
                    item["@id"]
                  )}`}
                >
...
const List = () => {
  ...
  const id = (page && decodeURIComponent(page)) || "document-templates";
