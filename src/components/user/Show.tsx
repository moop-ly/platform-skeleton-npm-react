        ...
        <table className="table table-responsive table-striped table-hover">
          ...
          <tbody>
            <tr>
              ...
              <td>{item["plainPassword"]}retrieved</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>{item["telephone"]}retrieved</td>
            </tr>
            <tr>
              <th scope="row">dateOfBirth</th>
              <td>{item["dateOfBirth"]}retrieved</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>{item["karma"]}retrieved</td>
            </tr>
            <tr>
              <th scope="row">loyaltyPoints</th>
              <td>{item["loyaltyPoints"]}retrieved</td>
            </tr>
            <tr>
