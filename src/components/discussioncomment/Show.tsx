...
const ShowView = ({
  ...
  if (deleted) {
    return <Navigate to="/discussioncomments/" replace />;
  }
  ...
  return (
    <div>
      <h1>Show DiscussionComment {item && item["@id"]}</h1>
      ...
      {item && (
        <table className="table table-responsive table-striped table-hover">
          ...
          <tbody>
            ...
            <tr>
              <th scope="row">pinned</th>
              <td>{item["pinned"]}retrieved</td>
            </tr>
            <tr>
      ...
      <Link to="/discussioncomments/" className="btn btn-primary">
        Back to list
      </Link>
      {item && (
        <Link
          to={`/discussioncomments/edit/${encodeURIComponent(item["@id"])}`}
        >
