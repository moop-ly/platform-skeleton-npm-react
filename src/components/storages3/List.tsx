        ...
        <tbody>
          {items.map((item) => (
            <tr key={item["@id"]}>
              ...
              <td>
                <Link
                  to={`/storages3s/show/${encodeURIComponent(item["@id"])}`}
                >
              ...
              <td>
                <Link
                  to={`/storages3s/edit/${encodeURIComponent(item["@id"])}`}
                >
...
const List = () => {
  ...
  const id = (page && decodeURIComponent(page)) || "storage-s3s";
