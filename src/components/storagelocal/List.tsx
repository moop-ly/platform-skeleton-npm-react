        ...
        <tbody>
          {items.map((item) => (
            <tr key={item["@id"]}>
              ...
              <td>
                <Link
                  to={`/storagelocals/show/${encodeURIComponent(item["@id"])}`}
                >
              ...
              <td>
                <Link
                  to={`/storagelocals/edit/${encodeURIComponent(item["@id"])}`}
                >
...
const List = () => {
  ...
  const id = (page && decodeURIComponent(page)) || "storage-local";
