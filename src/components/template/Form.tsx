...
const Form = ({ onSubmit, error, reset, initialValues }: FormProps) => {
  ...
  const onFormSubmit: SubmitHandler<TResource> = (data) => {
    onSubmit({
      ...data,
      notifications: normalizeLinks(data["notifications"]),
    });
  };
  ...
  return (
    <form onSubmit={handleSubmit(onFormSubmit)}>
      <Field
        register={register}
        name="type"
        placeholder="The TemplateType this template belongs to."
        type="text"
        errors={errors}
      />
      <Field
      ...
      <Field
        register={register}
        name="notifications"
        placeholder="The Notifications that use this template."
        type="text"
        errors={errors}
      />
      <Field
