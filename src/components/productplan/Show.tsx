...
const ShowView = ({
  ...
  if (deleted) {
    return <Navigate to="/productplans/" replace />;
  }
  ...
  return (
    <div>
      <h1>Show ProductPlan {item && item["@id"]}</h1>
        ...
        <table className="table table-responsive table-striped table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <Links
                  items={item["products"].map((ref: any) => ({
                    href: `/products/show/${encodeURIComponent(ref)}`,
                    name: ref,
                  }))}
                />
              </td>
            ...
            <tr>
              ...
              <td>
                <Links
                  items={item["networks"].map((ref: any) => ({
                    href: `/networks/show/${encodeURIComponent(ref)}`,
                    name: ref,
                  }))}
                />
              </td>
      ...
      <Link to="/productplans/" className="btn btn-primary">
        Back to list
      </Link>
      {item && (
        <Link to={`/productplans/edit/${encodeURIComponent(item["@id"])}`}>
