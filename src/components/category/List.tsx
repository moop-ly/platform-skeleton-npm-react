          ...
          {items.map((item) => (
            <tr key={item["@id"]}>
              ...
              <td>
                <Links
                  items={{
                    href: `/categories/show/${encodeURIComponent(
                      item["parent"]
                    )}`,
                    name: item["parent"],
                  }}
              ...
              <td>
                <Link to={`/categorys/show/${encodeURIComponent(item["@id"])}`}>
                  <span className="fa fa-search" aria-hidden="true" />
                  <span className="sr-only">Show</span>
                </Link>
              </td>
              <td>
                <Link to={`/categorys/edit/${encodeURIComponent(item["@id"])}`}>
...
const List = () => {
  ...
  const id = (page && decodeURIComponent(page)) || "categories";
