        ...
        <tbody>
          {items.map((item) => (
            <tr key={item["@id"]}>
              ...
              <td>
                <Link
                  to={`/chatmessages/show/${encodeURIComponent(item["@id"])}`}
                >
              ...
              <td>
                <Link
                  to={`/chatmessages/edit/${encodeURIComponent(item["@id"])}`}
                >
...
const List = () => {
  ...
  const id = (page && decodeURIComponent(page)) || "chat-messages";
