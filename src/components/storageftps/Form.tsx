  ...
  return (
    <form onSubmit={handleSubmit(onFormSubmit)}>
      ...
      <Field
        register={register}
        name="privateKey"
        placeholder="The cryptographic key used for authentication."
        type="text"
        errors={errors}
      />
      <Field
        ...
        placeholder="The phrase used to sign the cryptographic key provided in privateKey."
        type="text"
        errors={errors}
      />
      <Field
        ...
        placeholder="The SSH host's fingerprint used to authenticate the server."
        type="text"
        errors={errors}
      />
      <Field
