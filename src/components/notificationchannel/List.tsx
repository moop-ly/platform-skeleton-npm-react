...
const ListView = ({ error, loading, retrieved }: ListProps) => {
  ...
  return (
    <div>
      <h1>NotificationChannel List</h1>
        ...
        <tbody>
          {items.map((item) => (
            <tr key={item["@id"]}>
              ...
              <td>
                <Link
                  to={`/notificationchannels/show/${encodeURIComponent(
                    item["@id"]
                  )}`}
                >
              ...
              <td>
                <Link
                  to={`/notificationchannels/edit/${encodeURIComponent(
                    item["@id"]
                  )}`}
                >
...
const List = () => {
  ...
  const id = (page && decodeURIComponent(page)) || "notification-channels";
