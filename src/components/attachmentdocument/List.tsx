        ...
        <tbody>
          {items.map((item) => (
            <tr key={item["@id"]}>
              ...
              <td>
                <Link
                  to={`/attachmentdocuments/show/${encodeURIComponent(
                    item["@id"]
                  )}`}
                >
              ...
              <td>
                <Link
                  to={`/attachmentdocuments/edit/${encodeURIComponent(
                    item["@id"]
                  )}`}
                >
...
const List = () => {
  ...
  const id = (page && decodeURIComponent(page)) || "attachment-documents";
