...
const ShowView = ({
  ...
  return (
    <div>
      <h1>Show Discussion {item && item["@id"]}</h1>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <Links
                  items={{
                    href: `/discussion-types/show/${encodeURIComponent(
                      item["type"]
                    )}`,
                    name: item["type"],
                  }}
            ...
            <tr>
              <th scope="row">numComments</th>
              <td>{item["numComments"]}retrieved</td>
            </tr>
            <tr>
