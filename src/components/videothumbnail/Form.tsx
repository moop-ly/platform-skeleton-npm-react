  ...
  return (
    <form onSubmit={handleSubmit(onFormSubmit)}>
      ...
      <Field
        register={register}
        name="media"
        placeholder="The Video associated with this thumbnail."
        type="text"
        errors={errors}
      />
      <Field
      ...
      <Field
        register={register}
        name="mediaFile"
        placeholder="The VideoFile associated with this thumbnail."
        type="text"
        errors={errors}
      />
      <Field
        register={register}
        name="template"
        placeholder="The VideoThumbnailTemplate associated with this thumbnail (if any)."
        type="text"
        errors={errors}
      />
      <Field
        register={register}
        name="timestamp"
        placeholder="The timestamp where this image was extracted."
        type="text"
        errors={errors}
      />
      <Field
