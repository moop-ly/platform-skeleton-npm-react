...
const ShowView = ({
  ...
  if (deleted) {
    return <Navigate to="/videothumbnails/" replace />;
  }
  ...
  return (
    <div>
      <h1>Show VideoThumbnail {item && item["@id"]}</h1>
        ...
        <table className="table table-responsive table-striped table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{item["timestamp"]}retrieved</td>
            </tr>
            <tr>
      ...
      <Link to="/videothumbnails/" className="btn btn-primary">
        Back to list
      </Link>
      {item && (
        <Link to={`/videothumbnails/edit/${encodeURIComponent(item["@id"])}`}>
