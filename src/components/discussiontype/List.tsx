        ...
        <tbody>
          {items.map((item) => (
            <tr key={item["@id"]}>
              ...
              <td>{item["autoLockNumWeeks"]}</td>
              <td>{item["stripTags"]}</td>
              <td>{item["checkSpam"]}</td>
              <td>{item["triggerWords"]}</td>
              <td>{item["publish"]}</td>
              <td>{item["title"]}</td>
              ...
              <td>
                <Link
                  to={`/discussiontypes/show/${encodeURIComponent(
                    item["@id"]
                  )}`}
                >
              ...
              <td>
                <Link
                  to={`/discussiontypes/edit/${encodeURIComponent(
                    item["@id"]
                  )}`}
                >
...
const List = () => {
  ...
  const id = (page && decodeURIComponent(page)) || "discussion-types";
