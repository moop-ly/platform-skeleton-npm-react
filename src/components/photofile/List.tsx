        ...
        <tbody>
          {items.map((item) => (
            <tr key={item["@id"]}>
              ...
              <td>
                <Link
                  to={`/photofiles/show/${encodeURIComponent(item["@id"])}`}
                >
              ...
              <td>
                <Link
                  to={`/photofiles/edit/${encodeURIComponent(item["@id"])}`}
                >
...
const List = () => {
  ...
  const id = (page && decodeURIComponent(page)) || "photo-files";
