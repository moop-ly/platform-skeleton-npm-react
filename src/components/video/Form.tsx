  ...
  return (
    <form onSubmit={handleSubmit(onFormSubmit)}>
      ...
      <Field
        register={register}
        name="type"
        placeholder="Optional. Provide a Type either to logically group this media, or if templates are defined run it through the encoding system."
        type="text"
        errors={errors}
      />
      <Field
      ...
      <Field
        register={register}
        name="attachments"
        placeholder="The attachments the video belongs to."
        type="text"
        errors={errors}
      />
      <Field
      ...
      <Field
        register={register}
        name="mediaFiles"
        placeholder="The encoded media files generated by the VideoTemplates belonging to this object's Type."
        type="text"
        errors={errors}
      />
      <Field
      ...
      <Field
        register={register}
        name="meta"
        placeholder="Details encoding details about the file."
        type="text"
        errors={errors}
      />
      <Field
