...
const ShowView = ({
  ...
  return (
    <div>
        ...
        <table className="table table-responsive table-striped table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{item["priority"]}retrieved</td>
            </tr>
            <tr>
              <th scope="row">sites</th>
              <td>
                <Links
                  items={item["sites"].map((ref: any) => ({
                    href: `/sites/show/${encodeURIComponent(ref)}`,
                    name: ref,
                  }))}
                />
              </td>
      ...
      <Link to="/tiers/" className="btn btn-primary">
        Back to list
      </Link>
      {item && (
        <Link to={`/tiers/edit/${encodeURIComponent(item["@id"])}`}>
